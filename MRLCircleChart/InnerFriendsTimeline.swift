...
let cellIdInner = "cellIdInner"

class PostInnerFriends{
...
class InnerFriendsTimeline: UICollectionViewController , UICollectionViewDelegateFlowLayout  {
  
  var posts = [PostInnerFriends]()
  ...
  override func viewDidLoad() {
    ...
    let postSteve = PostInnerFriends()
    ...
    let postGandhi = PostInnerFriends()
    ...
    let postDonald = PostInnerFriends()
    ...
    navigationItem.title = "Inner Circle Timeline"
  ...
  override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
    let feedCell = collectionView.dequeueReusableCellWithReuseIdentifier(cellIdInner, forIndexPath: indexPath) as! FeedCellInner
...
class FeedCellInner : UICollectionViewCell {
  
  var feedController : InnerFriendsTimeline?
